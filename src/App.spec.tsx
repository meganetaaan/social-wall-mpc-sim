...
describe('App', () => {
  ...
  it('renders the simulator view, controls, tunable parameters, and cost panel', () => {
    ...
    expect(screen.getByText(/wall assoc acc/i)).toBeInTheDocument()
    ...
    expect(screen.getByText(/state-lattice policy service/i)).toBeInTheDocument()
    expect(screen.getByText(/backend/i)).toBeInTheDocument()
    expect(screen.getByText(/in-process/i)).toBeInTheDocument()
    expect(screen.getByText(/ready \/ pending/i)).toBeInTheDocument()
    expect(screen.getByText(/hits \/ misses/i)).toBeInTheDocument()
    ...
    expect(screen.getByRole('option', { name: /ambiguous parallel corridor/i })).toBeInTheDocument()
